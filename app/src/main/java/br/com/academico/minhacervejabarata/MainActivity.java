...
/*
       ...
       Supermercado supermercado = new Supermercado("Bompreço", "Brotas");
        supermercado = db.createSupermercado(supermercado);


        Supermercado supermercado2 = new Supermercado("Extra", "Paralela");
        ...
        for(Produto p : db.getAllProduto()){
            System.out.println("Supermercado: "+p.getSupermercado().getNome());
...
*/
        ...
        for(ItensCesta ic : db.getAllItensCestaById(2)){
            System.out.println("NOME SUPERMERCADO: "+ic.getProduto().getSupermercado().getNome());
       ...
       /* for(ItensCesta ic : ce.getItensCesta()){
        ...
        /*for(ItensCesta ic : db.getAllItensCesta()){
            ...
            System.out.println("DAta: "+ic.getProduto().getSupermercado().getNome());
            System.out.println("===========================================");
        }*/
